...
% Inizializziamo il punteggio migliore con il valore peggiore possibile (1.0 = totalmente diversi).
best_score = 1.0;

% 3. Normalizza
total_bits = numel(template1);

% Facciamo il confronto per ogni shift e teniamo il risultato migliore
for s = shifts
